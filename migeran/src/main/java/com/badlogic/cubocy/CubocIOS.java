...
@ObjCClassName("CubocIOS")
public class CubocIOS extends NSObject implements UIApplicationDelegate {
	...
	public boolean applicationDidFinishLaunchingWithOptions(
		...
		this.app = new IOSApplication(new Cubocy(), config);
	...
	@Generated("NatJ")
	@Selector("alloc")
	public static native CubocIOS alloc();

	@Generated("NatJ")
	protected CubocIOS(Pointer peer) {
		super(peer);
	}
	
	@Selector("init")
	public CubocIOS init() {
		super.init();
		return this;
	}
